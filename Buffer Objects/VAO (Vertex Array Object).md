...
we can define the position of the data inside the [VBO](obsidian://open?vault=OpenGL&file=VBO%20(Vertex%20Buffer%20Object)) like so: [[#Example Usage (given the above example with the drawing)]]
